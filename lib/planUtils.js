...
- Record semi-marathon : ${plan.physiology.semiMarathonRecord.time} (${plan.physiology.semiMarathonRecord.pace})

Plan d'entraînement : semaine ${week}/${plan.trainingPlan.totalWeeks} (${weekType}), ${plan.trainingPlan.sessionsPerWeek} séances/semaine
...
module.exports = { formatDateFr, getTrainingWeek, getWeekType, buildPlanContext };
