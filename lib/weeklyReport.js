    ...
    const weekOverWeek = thisWeekEntry && previousWeekEntry
      ? {
          ...
          deltaPercent: previousWeekEntry.actualKm > 0
            ...
            : null,
          deltaSessions: thisWeekEntry.sessionsCount - previousWeekEntry.sessionsCount,
        }
      : null;

    const weeklyStats = { zoneDistribution, maxHRObserved, longRun, restDays, weekOverWeek };
