...
const { formatPace, parseGarminDate, isRunningActivity, isSwimmingActivity, summarizeWeight, summarizeSplits, summarizeTrainingStatus, summarizeRunningDynamics } = require('./garminUtils');
