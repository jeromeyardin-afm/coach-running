...
module.exports = async (req, res) => {
  try {
    ...
    // que weeklyStats.longRun). Limite connue : si la Récupération est
    // faite en natation plutôt qu'en footing, elle n'apparaît pas dans les
    // activités de course Garmin et shortSessionsCount peut sous-compter
    // une semaine par ailleurs conforme au plan.
