...
class CoachMarathon {
  async analyzeActivity(activity, sleep = null, splits = null, trainingStatus = null) {
...
4. Hydratation/nutrition si besoin`;
  ...
  async generateWeeklyReport(activities, weeklyProgress = [], weight = null, trainingStatus = null) {
