...
Base cette recommandation sur les signaux de récupération disponibles (FC repos et HRV de la nuit, Body Battery, équilibre de charge Garmin aérobie/anaérobie) en plus de la logique du plan. Si un signal de fatigue se dégage (FC repos ou HRV anormale, Body Battery faible, charge aérobie faible insuffisante ou anaérobie excessive), recommande un easy ou un repos plutôt qu'une séance dure même si le plan prévoyait de la qualité, et explique pourquoi dans "Raison". Si la recommandation est un jour de récupération/repos, précise explicitement que la natation est une option valable.`;
