...
4. Hydratation/nutrition si besoin`;
  ...
  async generateWeeklyReport(activities, weeklyProgress = []) {
...
${activities.map(a => `- ${a.date} : ${a.type} ${a.distance}km à ${a.pace}/km (FC ${a.avgHR} bpm, zone ${classifyByHR(a.avgHR)})`).join('\n')}
