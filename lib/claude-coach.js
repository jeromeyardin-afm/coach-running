...
Donne un feedback court et actionnable (4-5 points max) :
...
4. Prochaine séance à privilégier : en te basant sur l'enchaînement habituel (Qualité #1 → Easy court → Qualité #2 → Easy moyen → Sortie longue → Récup/Repos) et le type de séance qui vient d'être fait, propose la suite logique la plus probable. Si c'est un jour de récupération/repos qui s'impose, précise explicitement que la natation est une option valable ce jour-là
5. Hydratation/nutrition si besoin`;
