module.exports = {
  ...
  notes: [
    ...
    "Renforcement/gainage : viser 1-2 séances courtes (15-20 min) par semaine sur un jour easy ou repos, pour la prévention blessures — pas juste avant une séance de qualité",
    "Le gainage peut aussi se faire en piscine, à la suite d'une séance récup natation déjà prévue : planche ventrale/dorsale en flottaison, ciseaux de jambes tenu au mur, rotations du tronc à la frite, gainage latéral en abduction au mur",
    "Semaine 9 (sortie longue 28 km, 12 km à allure marathon) : test grandeur nature de l'allure marathon visée (4:58/km, écart serré de seulement +2,8% avec l'allure du semi contre 6-10% habituellement) — vérifier que la FC reste sous le seuil (181 bpm) sans dérive excessive sur l'ensemble du segment AM ; sert à confirmer l'objectif 3h30 ou à l'ajuster (ex. 3h33-35, plus proche de la prédiction Riegel) avant le bloc spécifique (semaines 10-11)",
    "Lignes droites (accélérations courtes) : 3 séries de 3x15s à allure vive mais contrôlée (pas un sprint à fond), récupération complète entre chaque, en fin de séance Récupération plutôt qu'après une séance de qualité — 1-2 fois par semaine, pour l'économie de course et le recrutement musculaire sans ajouter de fatigue significative",
    "Routine matinale courte (5-8 min, tous les matins, sans matériel) : 1 tour de squats poids du corps (15-20), planche (30-40s), pont fessier (15), gainage latéral (20-30s/côté), fentes alternées (10/jambe), montées sur pointe de pieds (15) — un seul tour, pas de séries multiples ni de repos long, coûte peu en fatigue donc compatible même après une séance de qualité la veille ; complète la routine gainage hebdomadaire sans la remplacer",
  ],
};
