module.exports = {
  ...
  trainingPlan: {
    totalWeeks: 13,
    // 5 séances de course par semaine (2 qualité + 2 easy + 1 sortie longue) :
    // le plan révisé (v4.0-RÉVISÉ-2seances, 13/08/2026) parle de "4 séances"
    // en ne comptant que qualité+easy, mais l'app compare ce chiffre au
    // nombre réel d'activités de course Garmin de la semaine, qui inclut la
    // sortie longue — donc 5 ici pour que le ratio réalisé/prévu reste juste.
    sessionsPerWeek: 5,
