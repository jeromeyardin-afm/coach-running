...
// planUtils.js, du plus facile (vert) au plus intense (rouge).
const ZONE_COLORS = {
  'Récupération / Facile': '#2ecc71',
  'Endurance fondamentale': '#27ae60',
  'Allure marathon': '#f39c12',
  'Tempo / Seuil': '#e67e22',
  'VMA / Fractionné court': '#e74c3c',
};
...
<body>
  ...
  async sendWeeklyReport(destinataire, subject, report, weekActivities, weekActualKm = null, weekPlannedKm = null, weeklyStats = null, trainingStatus = null, weeklyProgress = null) {
    const marked = await getMarked();
