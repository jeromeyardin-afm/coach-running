...
const { formatPace, parseGarminDate, summarizeSleep, summarizeSplits } = require('./garminUtils');
...
module.exports = async (req, res) => {
  try {
    ...
    for (const activity of newActivities) {
      ...
      const coachAdvice = await coach.analyzeActivity(activityData, sleep, splits);
