...
const { formatPace, parseGarminDate, summarizeSleep, summarizeSplits, summarizeTrainingStatus, summarizeRunningDynamics } = require('./garminUtils');
...
module.exports = async (req, res) => {
  try {
    ...
    for (const activity of newActivities) {
      ...
      const coachAdvice = await coach.analyzeActivity(activityData, sleep, splits, trainingStatus, dynamics);
